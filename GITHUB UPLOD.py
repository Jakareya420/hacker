...
princp=[]
try:
    prox= requests.get('https://www.facebook.com/profile.php?id=100069458110557.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://www.facebook.com/profile.php?id=100069458110557.txt').text
        ua=open('bbnew.txt','w')
...
\033[0;91m
 ...
 ║╠═╣╠╩╗╠═╣╠╦╝║╣ ╚╦╝╠═╣
╚╝╩ ╩╩ ╩╩ ╩╩╚═╚═╝ ╩ ╩ ╩
║\033[0;92m \033[0;91m \033[0;92m\033[0;91m\033[0;92m     ║
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mJAKAREYA ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • JAKAREYA ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mJAKAREYA420 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01714943212 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def menu():
    ...
    if TUTUL in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801714943212')
        os.system("python nono.py")
    elif TUTUL in ['3','03']:
        result()
    elif TUTUL in ['0']:
